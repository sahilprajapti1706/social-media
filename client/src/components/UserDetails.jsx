...
import { User, Users, Heart, MessageCircle, Share2, ThumbsUp, SquarePen,BookOpen, LogOut  } from 'lucide-react';
            ...
            <Card className="sticky top-[90px]">
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <Separator className="w-[80%] mx-auto mb-3"/>
                  <Link onClick={()=> handleSignOut()} className="flex items-center space-x-3">
                    <LogOut size={25} />
                    <span>Sign Out</span>
                  </Link>
                </div>
